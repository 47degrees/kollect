...
interface ExecutionContext {
     ...
     *  preparation later.
     */
    fun prepare(): ExecutionContext = this
    ...
    companion object {
         ...
         */
        fun global(): ExecutionContextExecutor = Implicits.global as ExecutionContextExecutor
        ...
        object Implicits {
             ...
             */
            val global: ExecutionContext = ExecutionContextImpl.fromExecutor(null)
        }
         ...
         */
        fun defaultReporter(): (Throwable) -> Unit = { it.printStackTrace() }
    }
}
 ...
 */
interface ExecutionContextExecutor : ExecutionContext, Executor

/**
 * An [[ExecutionContext]] that is also a
 * Java [[http://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ExecutorService.html ExecutorService]].
 */
interface ExecutionContextExecutorService : ExecutionContextExecutor, ExecutorService
